          ...
          <div className="container mx-auto px-4 lg:px-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-12 lg:gap-y-0 divide-y md:divide-y-0 lg:divide-x divide-slate-200">
              {objetivos.map((obj, idx) => (
                <div key={idx} className="flex flex-col items-center pt-8 md:pt-0 lg:px-8 first:lg:pl-0 last:lg:pr-0">
        ...
        <section id="nosotros" className="relative py-28 min-h-[500px] flex items-center">
          ...
          <div className="container mx-auto px-4 lg:px-12 relative z-10 text-white">
            <div className="max-w-2xl">
              ...
              <div className="space-y-6 text-[15px] md:text-[17px] leading-relaxed text-white/95">
                <p>
          ...
          <div className="container mx-auto px-4 lg:px-12">
            ...
            <div className="flex flex-wrap justify-center gap-6 max-w-5xl mx-auto">
              {portafolio.map((item, idx) => (
                <div key={idx} className="w-full sm:w-[calc(50%-12px)] md:w-[calc(33.333%-16px)] border border-green-200/60 rounded-2xl p-6 flex flex-col items-center justify-center min-h-[160px] text-center bg-white hover:shadow-md transition-shadow">
